...
data = json.load(open(f'{ROOT}/data/words.json', encoding='utf-8'))
words = data['words']
...
alphabet = json.load(open(f'{ROOT}/data/alphabet.json', encoding='utf-8'))
if len(alphabet) != 33:
    errors.append(f'в алфавите {len(alphabet)} букв вместо 33')

json.load(open(f'{ROOT}/data/mnemonics.json', encoding='utf-8'))
